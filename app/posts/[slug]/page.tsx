    ...
    return (
      <>
        ...
        <div className="max-w-4xl mx-auto space-y-4 relative z-0">
          ...
          <p
            className={`text-sm ${isLightMode ? "text-black" : "text-muted-foreground"}`}
          >
  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto relative z-0">
        ...
        <header className="mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 flex-wrap">
              <h1
                className={`text-5xl font-bold leading-tight tracking-tight ${isLightMode ? "text-black" : "text-white"}`}
              >
                {result.post.title}
              </h1>
            ...
            {result.post.excerpt && (
              <p
                className={`text-xl leading-relaxed ${isLightMode ? "text-black" : "text-slate-200"}`}
              >
                {result.post.excerpt}
              </p>
            )}
            ...
            {result.author && (
              <div
                className={`flex items-center gap-3 pt-4 border-t ${isLightMode ? "border-gray-300" : "border-slate-200"}`}
              >
                <Link
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div
                      className={`flex items-center gap-2 text-sm ${isLightMode ? "text-black" : "text-slate-300"}`}
                    >
                      <span>
                        {format(new Date(result.post.createdAt), "MMM d, yyyy")}
                      </span>
                      {readingTime && (
                        <>
                          <span>•</span>
            ...
            <div
              className={`flex items-center justify-between pt-4 border-t ${isLightMode ? "border-gray-300" : "border-slate-700"}`}
            >
              <div className="flex items-center gap-6">
                ...
                >
                  <Heart
                    className={`h-5 w-5 ${hasClapped ? "fill-red-400 text-red-400" : ""}`}
                  />
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <Bookmark
                    className={`h-5 w-5 ${hasBookmarked ? "fill-yellow-400 text-yellow-400" : ""}`}
                  />
                </button>
        ...
        >
          <div dangerouslySetInnerHTML={{ __html: result.post.content }} />
        </div>
        ...
        {/* Footer Navigation */}
        <div
          className={`mt-12 pt-8 border-t ${isLightMode ? "border-gray-300" : "border-slate-200"}`}
        >
          <Link
            href="/posts"
