        ...
        >
          <div>
            <p className="font-semibold mb-2">
              Method 1: Insert image in content (recommended)
            </p>
            <ol className="list-decimal list-inside space-y-1 ml-2">
              <li>
                Click the <ImageIcon className="inline h-4 w-4" /> image icon in
                the toolbar above
              </li>
              <li>Paste a direct image URL when prompted</li>
              <li>
                The image will appear in your content where your cursor is
              </li>
            </ol>
            <p
          ...
          >
            <p className="font-semibold mb-2">
              Method 2: Featured image (optional)
            </p>
            <p className="mb-2">
              Add a featured image URL in the &quot;Featured Image URL&quot;
              field above. This image will appear at the top of your post,
              similar to Medium articles.
            </p>
          </div>
          ...
          >
            ...
            <ol className="list-decimal list-inside space-y-1 ml-2">
              <li>
                Find an image on any website (Pexels, Unsplash, Imgur, etc.)
              </li>
            ...
            >
              Note: The URL must be a direct link to an image file (ending with
              .jpg, .png, .gif, etc.)
            </p>
          </div>
        </div>
